...
# model = YOLO("yolov8n.pt")  #for photo
# results = model("testing scripts\img.jpg", show=True)
# cv2.waitKey(0)

cap = cv2.VideoCapture(0)  # for webcam
cap.set(3, 640)
cap.set(4, 480)
yolo_source = "C:\\Users\\gupta\\AppData\\Local\\Programs\\Python\\Python310\\Lib\\site-packages\\ultralytics\\assets"
